...
/* 1. JUnit4 를 이용한다. */
@RunWith(SpringJUnit4ClassRunner.class) // 타입 명시

/*
 * 2. ContactDaoImple 클래스의 bean 생성 방법을 작성한다.
 *  1) <bean>         locations="file:src/main/webapp/WEB-INF/spring/root-context.xml"
 *  2) @Bean          classes=AppConfig.class
 *  3) @Componet      locations="file:src/main/webapp/WEB-INF/spring/appServlet/servlet-context.xml"
 */
...
public class ContactUnitTest {
  ...
  public void 등록테스트() {
    ...
    assertEquals(1, insertCount); // insertCount 가 1이면 -> test 성공
  }
