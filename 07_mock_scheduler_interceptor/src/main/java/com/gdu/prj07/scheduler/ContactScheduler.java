...
public class ContactScheduler {
   ...
   *    3) 시   : 0 ~ 23
   *    4) 일   : 1 ~ 31
   *    5) 월   : 0 ~ 11 (JAN, FEB, MAR, APR, MAY, JUN, JUL, AUG, SEP, OCT, NOV, DEC => 문자로도 기입가능)
   *    6) 요일 : 0 ~ 7  (SUN, MON, TUE, WED, THR, FRI, SAT, SUN) => 0 또는 7 은 SUN
   *     
   * 3. 키워드
   *    1) ? : 설정 없음 (요일)
   *    2) * : 모든 (초 분 시 일 월)
   *    3) - : 범위 (ex 0-30)
   *    4) / : 주기 (ex 0/10) => 반복주기 설정
   *    
   * 4. 예시
   *    1) 0 0 * * * *      : 매일 모든 시간마다 (1시, 2시, 3시 ...)
   *    2) 0 0 3 * * *      : 매일 3시마다
