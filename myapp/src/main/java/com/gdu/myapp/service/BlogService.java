...
public interface BlogService {
  ...
  BlogDto getBlogByNo(int blogNo);                                // 상세보기
  int registerComment(HttpServletRequest request);                // 댓글 작성
  Map<String, Object> getCommentList(HttpServletRequest request); // 댓글 목록
  int registerReply(HttpServletRequest request);                  // 답글 작성
}
